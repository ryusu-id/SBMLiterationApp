...
public class DownloadMasterGroupTemplateEndpoint : EndpointWithoutRequest<object>
{
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        var filePath = Path.Combine(binDirectory, "Templates", "MasterGroupTemplate.xlsx");
        ...
        await Send.StreamAsync(
            stream: file,
            fileName: "MasterGroupTemplate.xlsx",
